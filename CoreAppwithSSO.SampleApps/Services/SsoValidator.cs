...
/// <summary>
/// Server-side bridge to the Dashboard SSO API. Validates one-time tokens, polls
/// session status (so apps can detect logout from another app), and triggers global logout.
/// </summary>
public class SsoValidator : ISsoValidator
{
    ...
    private static SsoValidationResult InvalidValidation() => new(false, 0, 0, 0, "", "", "");
