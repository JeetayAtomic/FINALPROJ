...
public class SsoDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Application>().HasData(
            new Application { Id = 1, Name = "HR Portal", Description = "Human Resources Management", BaseUrl = "http://localhost:8081/hr/", IconName = "people", IconColor = "#4285F4", DisplayOrder = 1, CreatedAt = seedDate },
            new Application { Id = 2, Name = "Finance", Description = "Financial Management System", BaseUrl = "http://localhost:8081/finance/", IconName = "account_balance", IconColor = "#EA4335", DisplayOrder = 2, CreatedAt = seedDate },
            ...
            new Application { Id = 5, Name = "Inventory", Description = "Inventory Management System", BaseUrl = "http://localhost:8081/inventory/", IconName = "inventory_2", IconColor = "#FF6D01", DisplayOrder = 5, CreatedAt = seedDate },
